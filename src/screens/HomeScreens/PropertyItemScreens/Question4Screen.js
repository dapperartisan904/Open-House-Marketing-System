...
class Question4Screen extends Component {
  ...
  nobtn = () => {
    Constants.attendeereceivecma = '0';
    var flag = 0;
    var position = 0;
  ...
  yesbtn = () => {
    Constants.attendeereceivecma = '1';
        ...
        >
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_NORMAL * 3, marginBottom: Layouts.MARGIN_LARGE }}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold' }}>
                  Would You Like To Receive A Compartible
            </Text>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold' }}>
                  Market Analysis Of Your Current Property?
            </Text>
              </View>
