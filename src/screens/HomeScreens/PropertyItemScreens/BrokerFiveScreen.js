...
class BrokerFiveScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  nobtn = () => {
    ...
    this.props.navigation.navigate('brokerFinalScreen');
  };
  yesbtn = () => {
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: 20 }}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, marginTop: Layouts.MARGIN_NORMAL, fontWeight: 'bold' }}>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginTop: 10, fontWeight: 'bold' }}>Do You Want to Be Kept Informed?</Text>
            </View>
            <View style={styles.imgcontainer1}>
