...
class Question10Screen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  nobtn = () => {
    Constants.attendeehaverealestateattorney = '0';
    var flag = 0;
    var position = 0;
    for (let i = 10; i < Constants.checkArray.length; i++) {
  ...
  yesbtn = () => {
    Constants.attendeehaverealestateattorney = '1';
    var flag = 0;
    var position = 0;
    for (let i = 10; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
        ...
        >
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_NORMAL, marginBottom: Layouts.MARGIN_LARGE }}>
