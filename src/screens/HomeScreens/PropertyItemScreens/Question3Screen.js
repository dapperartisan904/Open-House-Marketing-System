...
class Question3Screen extends Component {
  ...
  nobtn = () => {
    Constants.attendeeneedtosellyesorno = '0';
    var flag = 0;
    var position = 0;
    for (let i = 3; i < Constants.checkArray.length; i++) {
  ...
  yesbtn = () => {
    Constants.attendeeneedtosellyesorno = '1';
    var flag = 0;
    var position = 0;
        ...
        <ImageBackground
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_NORMAL * 3, marginBottom: Layouts.MARGIN_LARGE, alignContent: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold', alignItems: 'center' }}>
                  Do You Need to List and Sell Your Current
              </Text>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold', alignSelf: 'center' }}>
                  Property Before Purchasing This One?
              </Text>
              </View>
