...
class Question5Screen extends Component {
  ...
  nobtn = () => {
    Constants.attendeeprospectmatch = '0';
    var flag = 0;
    var position = 0;
    for (let i = 5; i < Constants.checkArray.length; i++) {
  ...
  yesbtn = () => {
    Constants.attendeeprospectmatch = '1';
    var flag = 0;
    var position = 0;
    for (let i = 5; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
        ...
        <ImageBackground
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_NORMAL * 3, marginBottom: Layouts.MARGIN_LARGE, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold', alignSelf: 'center' }}>
                  Would You Like To Be Added To My Prospect
              </Text>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, fontWeight: 'bold', alignSelf: 'center' }}>
                  Match, So I May Send You Information About Similar Properties?
              </Text>
              </View>
          ...
          <View style={styles.formviewcontainer}>
            ...
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, fontWeight: 'bold' }}>
                Match, So I May Send You Information About
            </Text>
            </View>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginBottom: 10, fontWeight: 'bold' }}>Similar Properties?</Text>
            </View>
