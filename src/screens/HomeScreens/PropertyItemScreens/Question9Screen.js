...
class BuyerActivity extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  goodbtn = () => {
    Constants.attendeehowgoodisyourcredit = 'Good';
    var flag = 0;
    var position = 0;
    for (let i = 9; i < Constants.checkArray.length; i++) {
  ...
  notgoodbtn = () => {
    Constants.attendeehowgoodisyourcredit = 'Not Good';
    var flag = 0;
    var position = 0;
    for (let i = 9; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
  ...
  excellentbtn = () => {
    Constants.attendeehowgoodisyourcredit = 'Excellent';
    var flag = 0;
    var position = 0;
    for (let i = 9; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
  ...
  notsurebtn = () => {
    Constants.attendeehowgoodisyourcredit = 'Not Sure';
    var flag = 0;
    var position = 0;
    for (let i = 9; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
            ...
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: Layouts.MARGIN_LARGE, flexWrap: 'wrap' }}>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.goodbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>GOOD</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.notgoodbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>NOT GOOD</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.excellentbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>EXCELLENT</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.notsurebtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>NOT SURE</Text>
                  </Button>
                </View>
              </View>
            </View>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginTop: 10, marginBottom: 10, fontWeight: 'bold' }}>How Good Is Your Current Credit?</Text>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.goodbtn()}>
                <Text style={styles.btntxt}>GOOD</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.notgoodbtn()}>
                <Text style={styles.btntxt}>NOT GOOD</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button
                block
                style={styles.btn}
                onPress={() => this.excellentbtn()}>
                <Text style={styles.btntxt}>EXCELLENT</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.notsurebtn()}>
