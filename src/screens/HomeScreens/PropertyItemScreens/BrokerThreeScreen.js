...
class BrokerThreeScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  yesbtn = () => {
    ...
    this.props.navigation.navigate('brokerFourScreen');
  };
  nobtn = () => {
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginTop: 10, fontWeight: 'bold' }}>
                Do You Have Any Potntial Buyers For
            </Text>
            </View>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginBottom: 10, fontWeight: 'bold' }}>This Poperty?</Text>
            </View>
