...
class Question7Screen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  internetbtn = () => {
    Constants.attendeehearaboutlisting = 'INTERNET';
    this.props.navigation.navigate('websitesScreen');
  };
  newspaperbtn = () => {
    Constants.attendeehearaboutlisting = 'NEWSPAPER';
    this.props.navigation.navigate('newspaperScreen');
  };
  signoutsidebtn = () => {
    Constants.attendeehearaboutlisting = 'SIGN OUTSIDE';
    var flag = 0;
    var position = 0;
  ...
  otherbtn = () => {
    Constants.attendeehearaboutlisting = 'OTHER';
    var flag = 0;
    var position = 0;
    for (let i = 7; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
            ...
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: Layouts.MARGIN_LARGE, flexWrap: 'wrap' }}>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.internetbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>INTERNET</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.newspaperbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>NEWSPAPER</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.signoutsidebtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>SIGN OUTSIDE</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.otherbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>OTHER</Text>
                  </Button>
                </View>
              </View>
            </View>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            ...
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.internetbtn()}>
                <Text style={styles.btntxt}>INTERNET</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button
                block
                style={styles.btn}
                onPress={() => this.newspaperbtn()}>
                <Text style={styles.btntxt}>NEWSPAPER</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button
                block
                style={styles.btn}
                onPress={() => this.signoutsidebtn()}>
                <Text style={styles.btntxt}>SIGN OUTSIDE</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
