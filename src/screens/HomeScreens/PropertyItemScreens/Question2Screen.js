...
class Question2Screen extends Component {
  ...
  nobtn = () => {
    Constants.attendeepropertylistedyesorno = '0';
    var flag = 0;
    var position = 0;
    for (let i = 2; i < Constants.checkArray.length; i++) {
  ...
  yesbtn = () => {
    Constants.attendeepropertylistedyesorno = '1';
    var flag = 0;
    var position = 0;
            ...
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_LARGE }}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_BIG, marginTop: Layouts.MARGIN_NORMAL, marginBottom: Layouts.MARGIN_LARGE, fontWeight: 'bold' }}>
                  Is Your Current Property Listed?
            </Text>
              </View>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginTop: 10, marginBottom: 10, fontWeight: 'bold' }}>Is Your Current Property Listed?</Text>
            </View>
