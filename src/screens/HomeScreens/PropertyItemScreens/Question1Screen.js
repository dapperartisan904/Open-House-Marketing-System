...
class Question1Screen extends Component {
  ...
  ownahousebtn = () => {
    Constants.attendeeownorrent = 'Own';
    var flag = 0;
    var position = 0;
    for (let i = 1; i < Constants.checkArray.length; i++) {
  ...
  rentapropertybtn = () => {
    Constants.attendeeownorrent = 'Rent';
    var flag = 0;
    var position = 0;
        ...
        <ImageBackground
          ...
          <View style={{ flex: 3, alignContent: 'center', justifyContent: 'center' }}>
            <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: '100%', marginTop: Layouts.MARGIN_LARGE }}>
              ...
              <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: Layouts.MARGIN_LARGE * 2, }}>
                <View style={[styles.imgcontainer, { width: '50%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.ownahousebtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG, textAlign: 'center' }]}>OWN A HOUSE</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '50%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.rentapropertybtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG, textAlign: 'center' }]}>RENT A PROPERTY</Text>
                  </Button>
                </View>
              </View>
            </View>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: 16, marginTop: 10, marginBottom: 10, fontWeight: 'bold' }}>Do You Currently Own or Rent?</Text>
            </View>
            <View style={styles.imgcontainer}>
              <Button
                block
                style={styles.btn}
                onPress={() => this.ownahousebtn()}>
                <Text style={styles.btntxt}>OWN A HOUSE</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button
                block
                style={styles.btn}
                onPress={() => this.rentapropertybtn()}>
                <Text style={styles.btntxt}>RENT A PROPERTY</Text>
              </Button>
            </View>
          </View>
