...
class Question11Screen extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  textbtn = () => {
    Constants.attendeefollowupvia = 'Via Text';
    var flag = 0;
    var position = 0;
    for (let i = 11; i < Constants.checkArray.length; i++) {
  ...
  emailbtn = () => {
    Constants.attendeefollowupvia = 'By Email';
    var flag = 0;
    var position = 0;
    for (let i = 11; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
  ...
  callbtn = () => {
    Constants.attendeefollowupvia = 'Call Me';
    var flag = 0;
    var position = 0;
    for (let i = 11; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
  ...
  bothbtn = () => {
    Constants.attendeefollowupvia = 'Both Phone/Text';
    var flag = 0;
    var position = 0;
    for (let i = 11; i < Constants.checkArray.length; i++) {
      if (Constants.checkArray[i] === 1) {
            ...
            <View style={{ width: '90%', backgroundColor: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
              ...
              <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: Layouts.MARGIN_LARGE, flexWrap: 'wrap' }}>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.textbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>BY TEXT</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.emailbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>BY EMAIL</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.callbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>CALL ME</Text>
                  </Button>
                </View>
                <View style={[styles.imgcontainer, { width: '45%' }]}>
                  <Button style={[styles.btn, { height: Layouts.BIG_BUTTON_HEIGHT, justifyContent: 'center' }]} onPress={() => this.bothbtn()}>
                    <Text style={[{ color: 'white', fontSize: Layouts.TEXT_FONT_SIZE_BIG }]}>BOTH PHONE AND TEXT</Text>
                  </Button>
                </View>
              </View>
            </View>
        ...
        <ImageBackground
          ...
          <View style={styles.formviewcontainer}>
            <View style={styles.imgcontainer1}>
              <Text style={{ ontSize: 16, marginTop: 10, marginBottom: 10, fontWeight: 'bold' }}>
                How Would You Like Me To Follow Up With You?
            </Text>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.textbtn()}>
                <Text style={styles.btntxt}>BY TEXT</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.emailbtn()}>
                <Text style={styles.btntxt}>BY EMAIL</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.callbtn()}>
                <Text style={styles.btntxt}>CALL ME</Text>
              </Button>
            </View>
            <View style={styles.imgcontainer}>
              <Button block style={styles.btn} onPress={() => this.bothbtn()}>
                <Text style={styles.btntxt}>BOTH PHONE AND TEXT</Text>
              </Button>
            </View>
          </View>
