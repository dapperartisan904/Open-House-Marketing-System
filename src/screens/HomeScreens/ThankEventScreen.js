          ...
          <View style={[styles.formviewcontainer, { height: 400 }]}>
            <View style={styles.imgcontainer1}>
              <Text style={{
                ...
                marginTop: Layouts.MARGIN_NORMAL, marginBottom: Layouts.MARGIN_LARGE,
              }}>
                Thank You for Registering at
            </Text>
            </View>
            <View style={styles.imgcontainer1}>
              <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_TITLE, marginTop: Layouts.MARGIN_NORMAL }}>
            ...
            <View style={styles.imgcontainer2}>
              ...
              <View style={[styles.textdetail,{marginBottom: Layouts.MARGIN_NORMAL}]}>
                <Text style={{ fontSize: Layouts.TEXT_FONT_SIZE_NORMAL }}>
